...
<html lang="de">
    ...
    <body>
        <aside>
            <figure>
                <div id="avatar"></div>
                <figcaption><img src="https://crafatar.com/renders/body/<?php echo $uuid;?>?scale=6&overlay"><?php echo $name;?></figcaption>
                </figure>
        ...
        <main>
            ...
            <p class="bottom"><?php echo $uuid;?>Dieses Tool wurde von Snapecraft entwickelt und kann auf <a href="https://github.com/MayusYT/Chest">GitHub</a> heruntergeladen werden</p>
